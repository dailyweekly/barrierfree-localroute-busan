...
const PREF_LABEL: Record<string, string> = { safety: "🛡️ 안전 우선", low_congestion: "🌊 혼잡 회피", min_transfer: "🔁 환승 최소", include_local: "🍜 관광·맛집 코스" };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            {Object.entries(usageTrace).map(([id, u]) => (
              <div key={id} className="border border-slate-200 rounded-xl p-3 bg-bg-soft">
                <div className="font-bold text-brand-700">{u.provider}</div>
